    ...
    return (
        <header className="p-3 platform">
            ...
            <main className="container m-auto d-flex justify-content-center">
                <a href="#" id="jogar-agora" className="btn btn-warning" onClick={jogar}>Jogar Agora</a><p className="m-auto">Teste sua memória e tente fazer o maior combo possível! Combine as cartas com o mínimo de erros para ganhar pontos extras.</p>
            </main>
        </header>);
}
