  ...
  <div class="col-md-10 m-auto" style="position: sticky; top: 0; z-index: 999;">
    ...
    <div style="position: absolute; z-index: 99999">
      ...
      <div style="padding-top: 0; padding-bottom: 0;">
          ...
          <div id="frame" style="width: 100%;margin: auto;position: relative; z-index: 99998;height:100%; display: flex;flex-direction: column; justify-content: center">
            <div style="width: 100%;text-align:center;">
              <a style="display:inline-block;font-size: 13px;color: #263238;padding: 4px 10px;background: #F8F8F9;text-decoration: none; border-radius: 4px 4px 0 0;"
                id="frame-link"
                target="_blank"
                href="https://aads.com/campaigns/new?source_id=2410752&source_type=ad_unit&partner=2410752">
                Advertise here
              </a>
            </div>
            <iframe data-aa=2410752 src=//acceptable.a-ads.com/2410752/?size=Adaptive style='border:0; padding:0; width:70%; height:70%; overflow:hidden; margin: 0 auto'></iframe>
          </div>
          <label for="aadsstickymibu4v2b" style="top: 24px;margin:0 auto;right:0;left:0;max-width:24px; position: absolute;border-radius: 4px; background: rgba(248, 248, 249, 0.70); padding: 4px;z-index: 99999;cursor:pointer">
        ...
        <style>
          #aadsstickymibu4v2b:checked + div {
            display: none;
          }
        </style>
      </div>
