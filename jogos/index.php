...
<?php include("../gtagmanager.php"); ?>
  ...
  <div class="col-md-10 m-auto" style="position: sticky; top: 0; z-index: 999;">
    ...
    <div style="position: absolute; z-index: 99999">
      <input autocomplete="off" type="checkbox" id="aadsstickymibirl03" hidden />
      <div style="padding-top: auto; padding-bottom: 0;">
        <div style="width:100%;height:auto;position:fixed;text-align:center;font-size:0;top:0;left:0;right:0;margin:auto">
          <label for="aadsstickymibirl03" style="top: 50%;transform: translateY(-50%);right:24px;; position: absolute;border-radius: 4px; background: rgba(248, 248, 249, 0.70); padding: 4px;z-index: 99999;cursor:pointer">
        ...
        <style>
        #aadsstickymibirl03:checked + div {
          display: none;
        }
      </style>
      </div>
