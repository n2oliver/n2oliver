                        ...
                        <div class="proxima-linha text-white rounded-pill py-0 px-3 w-100 my-3">Óliver S. Castilho
                            <div class="nome-completo-osc" class="mt-4">Pronto para a próxima linha!
                                ...
                                <div class="d-flex align-content-end">
                                    <a class="libutton px-3" href="https://www.linkedin.com/comm/mynetwork/discovery-see-all?usecase=PEOPLE_FOLLOWS&followMember=oliver-c-ab2748b9" target="_blank"><i class="fa-brands fa-linkedin"></i> LinkedIn</a>
