...
<div style="position: absolute; z-index: 99999">
    <input autocomplete="off" type="checkbox" id="aadsstickyme937xxn" hidden />
    <div style="padding-top: 0; padding-bottom: auto;">
      <div style="width:100%;height:auto;position:fixed;text-align:center;font-size:0;bottom:0;left:0;right:0;margin:auto">
        <label for="aadsstickyme937xxn" style="top: 50%;transform: translateY(-50%);right:24px;; position: absolute;border-radius: 4px; background: rgba(248, 248, 249, 0.70); padding: 4px;z-index: 99999;cursor:pointer">
        ...
        <div id="frame" style="width: 100%;margin: auto;background: rgba(0, 0, 0, 0.50);position: relative; z-index: 99998;"><iframe data-aa=2406507 src=//acceptable.a-ads.com/2406507/?size=Adaptive style='border:0; padding:0; width:70%; height:auto; overflow:hidden; margin: auto'></iframe></div>
      </div>

  <script type='text/javascript' src='//witnessportfoliolobes.com/af/e7/3c/afe73c790e73cadb95ef255203cc5f61.js'></script>
      <style>
    #aadsstickyme937xxn:checked + div {
      display: none;
    }
    .gt_switcher_wrapper,
